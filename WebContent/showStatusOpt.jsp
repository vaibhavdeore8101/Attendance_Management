...
<script type="text/javascript">
	function getsubjects() {
		var action = "Show Status Subjects";
...
<body>
	...
	<div class="container" style="margin-top: 100px;">
		<section class="register">
			<h1>Show Attendance Status</h1>

			<form method="post" action="showstatus" name="status">
 ...
 --%>
				...
				<p class="submit">
					<input type="submit" name="action" value="Show Month Status">
					<input type="submit" name="action" value="Show Sem Status ">
